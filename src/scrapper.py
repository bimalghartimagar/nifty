...
class NIBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.nibl.com.np/forex/', timeout=5)
...
class NRBScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.nrb.org.np/fxmexchangerate.php', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class NMBScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('http://nmbbanknepal.com/forex', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class SBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.sanimabank.com/s/forex', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class EBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.everestbankltd.com/supports/interest-and-rates/forex/', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class SBIScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://nepalsbi.com.np/content/foreign-exchange-rates.cfm', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
        rate = b.find_all('table')[0].find_all('tr')[13].find_all('td')[3].string
...
class NBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.nepalbank.com.np/exchange-rate', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class LBBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('http://www.lumbinibikasbank.com/site/get_updated_forex_rate', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class BOKLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.bok.com.np/forex', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class NABILScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.nabilbank.com/exchange-rate', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
        rate = b.find_all('table')[0].find_all('tr')[2].find_all('td')[2].string
...
class HBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://himalayanbank.com/forex', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
        rate = b.find_all('table')[0].find_all('tr')[1].find_all('td')[3].string
...
class GIBScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('http://globalimebank.com/forex.html', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class MBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.machbank.com/forex', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
        rate = b.find_all('table')[0].find_all('tr')[1].find_all('td')[3].string
...
class ADBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('http://www.adbl.gov.np/adbl_exchange_rate.html', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class MBScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.megabanknepal.com/page/exchange-rate', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
...
class SCBLScrapper(Scrapper):
    ...
    def scrape_data(self):
        ...
        r=requests.get('https://www.sc.com/np/bank-with-us/forex-solution/foreign-currency-exchange-rates/', timeout=5)
        b = BeautifulSoup(r.content, "html.parser")
